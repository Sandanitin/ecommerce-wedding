...
const BottomNav = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/logout', label: 'Logout', icon: 'M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1' },
  ];
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`flex flex-col items-center justify-center flex-1 px-2 py-2 text-sm font-medium ${
                location.pathname === item.path ? 'text-red-600' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
